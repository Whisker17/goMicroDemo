...
import (
	fmt "fmt"
	model "github.com/Whisker17/goMicroDemo/proto/model"
...
type SayService interface {
	...
	MyName(ctx context.Context, in *model.SayParam, opts ...client.CallOption) (*model.SayResponse, error)
}
...
func (c *sayService) MyName(ctx context.Context, in *model.SayParam, opts ...client.CallOption) (*model.SayResponse, error) {
...
type SayHandler interface {
	...
	MyName(context.Context, *model.SayParam, *model.SayResponse) error
}
...
func RegisterSayHandler(s server.Server, hdlr SayHandler, opts ...server.HandlerOption) error {
	type say interface {
		...
		MyName(ctx context.Context, in *model.SayParam, out *model.SayResponse) error
	}
	type Say struct {
		say
	}
...
func (h *sayHandler) MyName(ctx context.Context, in *model.SayParam, out *model.SayResponse) error {
